  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-8">
        ...
        {fa.is_bridging && (
          <span className="text-xs px-2 py-0.5 rounded-lg border border-dashed border-brand-muted text-brand-muted font-medium">
            Bridging Area
          </span>
        )}
      </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {foundations.map(function (f: any) {
                  return (
                    <Link key={f.id} href="/foundations" className="block bg-white rounded-lg border-2 border-brand-border p-3 hover:shadow-sm transition-all">
