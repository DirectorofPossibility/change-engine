...
export default async function StoriesPage() {
  ...
  return (
    <div>
      <PageHero variant="sacred" sacredPattern="flower" gradientColor="#1a3460" title="Community Stories" subtitle="Real stories of impact, resilience, and connection from Houston neighbors. Every journey matters." />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-8 mt-4">
          <div className="space-y-4">
            {(stories || []).map(function (s: any) {
              return (
                <Link key={s.story_id || s.id} href={`/stories/${s.story_id || s.id}`} className="block bg-white border border-brand-border p-5 hover:border-ink transition-shadow">
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-4">
              <IndexWayfinder currentPage="stories" related={[{label:'Organizations',href:'/organizations'},{label:'News',href:'/news'},{label:'Neighborhoods',href:'/neighborhoods'}]} color="#1a3460" />
