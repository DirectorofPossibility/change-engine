...
const PERSONA_CONFIG: Record<string, {
  ...
  seeker: {
    ...
    quickActions: [
      { label: 'Search Services', href: '/services', color: '#d69e2e', effort: 'Browse' },
      { label: 'Find Organizations', href: '/organizations', color: '#dd6b20', effort: 'Browse' },
      { label: 'Benefits Finder', href: '/benefits', color: '#38a169', effort: 'Tool' },
  ...
  learner: {
    ...
    quickActions: [
      { label: 'Browse Library', href: '/library', color: '#3182ce', effort: 'Read' },
      { label: 'Learning Paths', href: '/learn', color: '#805ad5', effort: '30-90 min' },
      { label: 'Read the News', href: '/news', color: '#319795', effort: '5 min' },
      { label: 'Ask Chance', href: '/chat', color: '#C75B2A', effort: 'Chat' },
    ],
  },
  builder: {
    ...
    quickActions: [
      { label: 'Volunteer', href: '/opportunities', color: '#38a169', effort: 'Recurring' },
      { label: 'View Calendar', href: '/calendar', color: '#3182ce', effort: 'Events' },
      { label: 'Organizations', href: '/organizations', color: '#dd6b20', effort: 'Browse' },
  ...
  watchdog: {
    ...
    quickActions: [
      { label: 'Find Your Officials', href: '/officials', color: '#805ad5', effort: 'Browse' },
      { label: 'Track Policies', href: '/policies', color: '#3182ce', effort: 'Browse' },
      { label: 'Elections Hub', href: '/elections', color: '#e53e3e', effort: 'Dashboard' },
  ...
  partner: {
    ...
    quickActions: [
      { label: 'Organizations', href: '/organizations', color: '#dd6b20', effort: 'Browse' },
      { label: 'Foundations', href: '/foundations', color: '#805ad5', effort: 'Browse' },
      { label: 'Submit a Resource', href: '/me/submit', color: '#38a169', effort: '5 min' },
  ...
  explorer: {
    ...
    quickActions: [
      ...
      { label: 'Knowledge Graph', href: '/knowledge-graph', color: '#805ad5', effort: 'Interactive' },
      { label: 'Neighborhoods', href: '/neighborhoods', color: '#38a169', effort: 'Map' },
      { label: 'Search Everything', href: '/search', color: '#3182ce', effort: 'Search' },
    ],
  },
}
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: config.name + ' — Your Journey | Community Exchange',
