    ...
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-14 pr-6 py-4 text-base border border-brand-border bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-accent/40 focus:border-brand-accent placeholder:text-brand-muted/60"
        />
      </div>
    </form>
  )
