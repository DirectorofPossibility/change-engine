    ...
    <div className="bg-white border border-brand-border p-5 text-center">
      ...
      <div className="flex items-center justify-center gap-3">
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 border border-brand-border text-sm text-brand-text hover:bg-green-50 hover:border-green-300 transition-colors disabled:opacity-50"
        >
          <ThumbsUp size={14} />
          {t('library.vote_yes')}
        </button>
        <button
          ...
          disabled={isSubmitting}
          className="inline-flex items-center gap-2 px-4 py-2 border border-brand-border text-sm text-brand-text hover:bg-red-50 hover:border-red-300 transition-colors disabled:opacity-50"
        >
          <ThumbsDown size={14} />
          {t('library.vote_no')}
        </button>
