...
import {
  ...
  ArrowRight, ChevronDown, ChevronRight, Briefcase, BookOpen
} from 'lucide-react'
    ...
    <div className="mt-6">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Link
            href="/opportunities"
            className="group block p-5 rounded-lg border border-brand-border bg-white hover:shadow-sm hover:-translate-y-0.5 transition-all"
          >
