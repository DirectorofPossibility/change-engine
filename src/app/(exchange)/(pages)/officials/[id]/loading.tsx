      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center gap-4">
            <div className="h-20 w-20 bg-white/60 rounded-full animate-pulse" />
            <div className="space-y-2">
              <div className="h-8 w-48 bg-white/60 rounded animate-pulse" />
          ...
          <div className="space-y-3 mt-8">
            <div className="h-5 w-40 bg-white/60 rounded animate-pulse" />
            <div className="h-16 w-full bg-white/60 rounded-xl animate-pulse" />
            <div className="h-16 w-full bg-white/60 rounded-xl animate-pulse" />
            <div className="h-16 w-full bg-white/60 rounded-xl animate-pulse" />
          </div>
        </div>
