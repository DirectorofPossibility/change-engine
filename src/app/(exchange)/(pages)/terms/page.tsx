    ...
    <div style={{ background: PARCHMENT }} className="min-h-screen">
      ...
      <section className="relative overflow-hidden" style={{ background: PARCHMENT_WARM }}>
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-6 py-10">
          ...
          <h1 style={{ fontFamily: SERIF, color: INK }} className="text-2xl sm:text-3xl mt-2">Terms of Use</h1>
      ...
      <div className="max-w-[900px] mx-auto px-6 pt-4">
        <nav style={{ fontFamily: MONO, color: MUTED }} className="text-[11px] tracking-wide">
          ...
          <span style={{ color: INK }}>Terms of Use</span>
        </nav>
      </div>
        ...
        <div className="space-y-8" style={{ fontFamily: SERIF, color: INK }}>
          <section>
            <p className="leading-relaxed" style={{ color: MUTED }}>
              Welcome to <strong style={{ color: INK }}>The Change Lab</strong>, <strong style={{ color: INK }}>The Change Engine</strong>{' '}
              (www.changeengine.us), and the <strong style={{ color: INK }}>Change Engine</strong> (collectively, the
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">1. Our Mission and Values</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3" style={{ color: MUTED }}>
              <li><strong style={{ color: INK }}>Belonging Before Agreement</strong> -- Everyone deserves a seat at the table, regardless of background, beliefs, or political affiliation.</li>
              <li><strong style={{ color: INK }}>Connection First</strong> -- Real change starts with relationships and trust between neighbors.</li>
              <li><strong style={{ color: INK }}>The Whole Story</strong> -- We seek complete, honest, and contextualized information rather than simplified narratives.</li>
              <li><strong style={{ color: INK }}>Responsibility &amp; Fairness</strong> -- We hold ourselves and institutions accountable while centering equity and justice.</li>
              <li><strong style={{ color: INK }}>Imagination &amp; Tradition Together</strong> -- We honor what has come before while daring to envision what could be.</li>
              <li><strong style={{ color: INK }}>Practice, Not Perfection</strong> -- We learn by doing, welcome feedback, and grow through iteration.</li>
              <li><strong style={{ color: INK }}>Shared Work, Shared Future</strong> -- Community well-being is a collective responsibility.</li>
              <li><strong style={{ color: INK }}>Local Pride, Global Learning</strong> -- We are rooted in Houston and informed by ideas and solutions from around the world.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">2. Eligibility</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">3. Account Registration</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">4. License to Use the Platforms</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
              We grant you a <strong style={{ color: INK }}>limited, non-exclusive, non-transferable, revocable license</strong>{' '}
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">5. User Contributions</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">6. Prohibited Uses</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>When using the Platforms, you agree not to:</p>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">7. Third-Party Content and Links</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">8. Intellectual Property</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">9. Privacy</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
              Your use of the Platforms is also governed by our{' '}
              <a href="/privacy" style={{ color: CLAY }} className="hover:underline">
                Privacy Policy
              </a>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">10. Disclaimers and Limitation of Liability</h2>

            <h3 style={{ fontFamily: SERIF, color: INK }} className="text-lg mt-4 mb-2">10.1 Disclaimer of Warranties</h3>
            <p className="leading-relaxed" style={{ color: MUTED }}>
              The Platforms and all content are provided <strong style={{ color: INK }}>&ldquo;as is&rdquo;</strong> and{' '}
              <strong style={{ color: INK }}>&ldquo;as available&rdquo;</strong> without warranties of any kind, either
              express or implied, including but not limited to implied warranties of merchantability,
              fitness for a particular purpose, and non-infringement.
            </p>

            <h3 style={{ fontFamily: SERIF, color: INK }} className="text-lg mt-4 mb-2">10.2 Informational Purposes</h3>
            <p className="leading-relaxed" style={{ color: MUTED }}>
            ...
            <h3 style={{ fontFamily: SERIF, color: INK }} className="text-lg mt-4 mb-2">10.3 Limitation of Liability</h3>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">11. Indemnification</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">12. Termination</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">13. Governing Law</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">14. Changes to These Terms</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
          ...
          <section>
            <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-3">15. Contact Us</h2>
            <p className="leading-relaxed" style={{ color: MUTED }}>
