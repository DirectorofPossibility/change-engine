...
const InteractiveMap = dynamic(
  ...
  { ssr: false, loading: function () { return <div className="h-[400px] bg-brand-bg-alt animate-pulse" /> } }
)

export function TirzMap() {
  return (
    <div className=" overflow-hidden border border-brand-border mb-8" style={{ height: 400 }}>
      <InteractiveMap
