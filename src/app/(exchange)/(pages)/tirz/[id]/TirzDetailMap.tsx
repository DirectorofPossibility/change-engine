...
const InteractiveMap = dynamic(
  ...
  { ssr: false, loading: function () { return <div className="h-[280px] bg-brand-bg-alt animate-pulse" /> } }
)
...
export function TirzDetailMap({ siteNumber, markers }: TirzDetailMapProps) {
  return (
    <div className=" overflow-hidden border border-brand-border" style={{ height: 280 }}>
      <InteractiveMap
