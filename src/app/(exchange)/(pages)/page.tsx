  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-ink">
        {/* FOL watermarks for texture */}
        <div className="absolute left-[-120px] top-1/2 -translate-y-1/2 pointer-events-none opacity-[0.04]" aria-hidden="true">
            ...
            {CENTER_LIST.map(function (c) {
              ...
              return (
                <Link
                  key={c.slug}
                  href={c.href}
                  className="relative bg-white border border-rule overflow-hidden transition-all hover:shadow-lg hover:translate-y-[-2px] group"
                >
                  {/* Color accent top */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-6">
            ...
            {featured && (
              <Link
                ...
                className="bg-white border border-rule overflow-hidden transition-all hover:shadow-lg hover:translate-y-[-2px]"
              >
                {featured.image_url ? (
              ...
              {sideItems.map(function (item: any) {
                ...
                return (
                  <Link
                    ...
                    className="flex bg-white border border-rule overflow-hidden transition-all hover:shadow-md group"
                  >
                    {item.image_url ? (
            ...
            {THEME_LIST.map(function (t) {
              ...
              return (
                <Link
                  ...
                  className="flex items-center gap-3 bg-white border border-rule px-4 py-3.5 transition-all hover:shadow-md hover:translate-y-[-1px] group"
                >
