    ...
    <div style={{ background: PARCHMENT }} className="min-h-screen">
      ...
      <section className="relative overflow-hidden" style={{ background: PARCHMENT_WARM }}>
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-6 py-14">
          ...
          <h1 style={{ fontFamily: SERIF, color: INK }} className="text-3xl sm:text-4xl mt-2">
            Community life, organized.
          </h1>
          <p style={{ fontFamily: SERIF, color: MUTED }} className="text-lg mt-3 max-w-xl leading-relaxed">
          ...
          <div className="flex items-center gap-8 mt-6">
            <div>
              <p style={{ fontFamily: SERIF, color: INK }} className="text-2xl font-bold">{totalResources.toLocaleString()}</p>
              <p style={{ fontFamily: MONO, color: MUTED }} className="text-[11px] uppercase tracking-wide">total resources</p>
            </div>
            <div className="w-px h-10" style={{ background: RULE_COLOR }} />
            <div>
              <p style={{ fontFamily: SERIF, color: INK }} className="text-2xl font-bold">{stats.organizations || 0}</p>
              <p style={{ fontFamily: MONO, color: MUTED }} className="text-[11px] uppercase tracking-wide">organizations</p>
            </div>
            <div className="w-px h-10" style={{ background: RULE_COLOR }} />
            <div>
              <p style={{ fontFamily: SERIF, color: INK }} className="text-2xl font-bold">{stats.officials || 0}</p>
              <p style={{ fontFamily: MONO, color: MUTED }} className="text-[11px] uppercase tracking-wide">officials</p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[900px] mx-auto px-6 py-8">
        ...
        <div className="flex items-baseline justify-between mb-1">
          <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl">What We Do</h2>
          <span style={{ fontFamily: MONO, color: MUTED }} className="text-[11px]">{SECTIONS.length} areas</span>
        </div>
        ...
        <div className="space-y-5">
          {SECTIONS.map(function (section) {
            return (
              <div key={section.title} className="p-6" style={{ border: '1px solid ' + RULE_COLOR }}>
                <h3 style={{ fontFamily: SERIF, color: INK }} className="text-lg mb-2">{section.title}</h3>
                <p style={{ fontFamily: SERIF, color: MUTED }} className="text-sm leading-relaxed">{section.body}</p>
              </div>
            )
          })}
        </div>
        ...
        {/* ── Theory of Change ── */}
        <div className="flex items-baseline justify-between mb-1">
          <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl">Theory of Change</h2>
          <span style={{ fontFamily: MONO, color: MUTED }} className="text-[11px]">{THEORY_OF_CHANGE.length} principles</span>
        </div>
        <div style={{ borderBottom: '2px dotted ' + RULE_COLOR }} className="mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {THEORY_OF_CHANGE.map(function (item) {
            return (
              <div key={item.title} className="p-6" style={{ border: '1px solid ' + RULE_COLOR }}>
                <h3 style={{ fontFamily: SERIF, color: INK }} className="text-base mb-2">{item.title}</h3>
                <p style={{ fontFamily: SERIF, color: MUTED }} className="text-sm leading-relaxed">{item.body}</p>
              </div>
            )
          })}
        </div>
        ...
        {/* ── How We Organize ── */}
        <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-1">How We Organize</h2>
        <div style={{ borderBottom: '2px dotted ' + RULE_COLOR }} className="mb-6" />

        <div className="p-6" style={{ border: '1px solid ' + RULE_COLOR }}>
          <div className="space-y-3 max-w-2xl text-sm leading-relaxed" style={{ fontFamily: SERIF, color: MUTED }}>
            <p className="flex gap-2">
              <span className="w-2 h-2 flex-shrink-0 mt-1.5" style={{ background: CLAY }} />
              <span>All content is organized around <strong style={{ color: INK }}>7 community pathways</strong> -- Health, Families, Neighborhood, Voice, Money, Planet, and The Bigger We -- and <strong style={{ color: INK }}>4 engagement modes</strong>: Learning, Action, Resource, and Accountability.</span>
            </p>
            <p className="flex gap-2">
              <span className="w-2 h-2 flex-shrink-0 mt-1.5" style={{ background: CLAY }} />
              <span>We use <strong style={{ color: INK }}>asset-based language</strong> -- focusing on strengths, opportunities, and what is available rather than deficits. Every community has resources to build on, and every resident has something valuable to contribute.</span>
            </p>
            <p className="flex gap-2">
              <span className="w-2 h-2 flex-shrink-0 mt-1.5" style={{ background: CLAY }} />
              <span>Every entity is classified across <strong style={{ color: INK }}>16 taxonomy dimensions</strong> using AI -- from focus areas and SDGs to audiences and service categories -- then connected via a knowledge mesh so resources travel across pathways.</span>
            </p>
          </div>
        </div>
        ...
        <h2 style={{ fontFamily: SERIF, color: INK }} className="text-xl mb-1">Explore the Exchange</h2>
        <div style={{ borderBottom: '2px dotted ' + RULE_COLOR }} className="mb-6" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            return (
              ...
              >
                <h3 style={{ fontFamily: SERIF, color: INK }} className="text-sm mb-1">{item.label}</h3>
                <p style={{ fontFamily: MONO, color: MUTED }} className="text-xs">{item.desc}</p>
                <span style={{ fontFamily: MONO, color: CLAY }} className="inline-block mt-3 text-[10px]">
                  Explore &rarr;
                </span>
              </Link>
            )
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="p-6" style={{ background: PARCHMENT_WARM }}>
            <p style={{ fontFamily: SERIF, color: INK }} className="font-bold mb-1">Built by The Change Lab</p>
          ...
          <div className="p-6" style={{ background: PARCHMENT_WARM }}>
            <p style={{ fontFamily: SERIF, color: INK }} className="font-bold mb-1">Partner With Us</p>
            <p style={{ fontFamily: SERIF, color: MUTED }} className="text-sm leading-relaxed">
        ...
        {/* Legal */}
        <div className="flex flex-wrap gap-4 mt-8 pt-6" style={{ borderTop: '1px solid ' + RULE_COLOR }}>
          {[
            ...
            return (
              <Link key={link.href} href={link.href} style={{ fontFamily: MONO, color: MUTED }} className="text-xs hover:underline">
                {link.label}
              </Link>
            )
          })}
