    ...
    <div>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 sm:px-8 py-14 lg:py-20">
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="flex-1 min-w-0 max-w-xl">
              ...
              <h1 className="font-serif text-[clamp(2.2rem,5vw,3.5rem)] leading-[1.05] tracking-tight mb-5 text-brand-text">
                Community life,{' '}
              ...
              <div className="flex items-center gap-8">
                ...
                <FOLStat value={stats.organizations || 0} label="organizations" color="#38a169" />
                <div className="w-px h-10 bg-brand-border" />
                <FOLStat value={stats.officials || 0} label="officials" color="#805ad5" />
              </div>
            </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="font-serif text-2xl font-bold text-brand-text">Connecting people to civic life</h2>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-brand-border bg-white p-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="font-serif font-bold text-brand-text text-xl">How We Organize</h2>
          </div>
          <div className="text-sm text-brand-muted leading-relaxed space-y-3 max-w-2xl">
            <p className="flex gap-2">
              <FOLBullet size={14} color="#C75B2A" className="mt-1" />
            ...
            <p className="flex gap-2">
              <FOLBullet size={14} color="#38a169" className="mt-1" />
            ...
            <p className="flex gap-2">
              <FOLBullet size={14} color="#3182ce" className="mt-1" />
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="font-serif text-2xl font-bold text-brand-text">Explore the Exchange</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { href: '/library', label: 'Library', desc: 'Research, reports, and policy briefs', color: '#3182ce' },
            { href: '/services', label: 'Services', desc: 'Food, health, legal aid, and more', color: '#C75B2A' },
            { href: '/officials', label: 'Officials', desc: 'Who represents you at every level', color: '#805ad5' },
            { href: '/opportunities', label: 'Opportunities', desc: 'Volunteer, intern, get involved', color: '#38a169' },
          ].map(function (item) {
            return (
              <Link
                key={item.href}
                href={item.href}
                className="group relative overflow-hidden rounded-xl border p-5 hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
              ...
              >
                ...
                <h3 className="font-serif font-bold text-brand-text text-sm flex items-center gap-2 group-hover:text-brand-accent transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="relative overflow-hidden bg-brand-bg-alt rounded-2xl p-6">
            ...
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-brand-accent/10 flex items-center justify-center flex-shrink-0">
                <FOLBullet size={18} color="#C75B2A" />
              </div>
              <div>
