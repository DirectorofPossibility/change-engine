  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <button
          onClick={reset}
          className="px-5 py-2.5 bg-blue text-white font-mono uppercase hover:opacity-90 transition-opacity" style={{ fontSize: "0.7rem", letterSpacing: "0.08em", fontWeight: 600 }}
        >
          Try again
        </button>
      </div>
