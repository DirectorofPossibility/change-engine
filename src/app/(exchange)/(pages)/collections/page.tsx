...
export default async function CollectionsPage() {
  ...
  return (
    <div>
      <PageHero variant="sacred" sacredPattern="vesica" gradientColor="#C75B2A" title="Curated Collections" subtitle="Thoughtfully assembled collections of resources, guides, and content to help you navigate what matters most." />
