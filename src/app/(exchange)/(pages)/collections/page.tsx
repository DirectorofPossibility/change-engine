          ...
          {items.length > 0 && (
            <div className="flex flex-wrap gap-8 mt-8">
              <div>
                ...
                <span style={{ fontSize: '0.65rem', color: "#5c6474", textTransform: 'uppercase', letterSpacing: '0.1em', display: 'block' }}>Collections</span>
              </div>
            </div>
          )}
        </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {(c.description_5th_grade || c.description || c.summary) && (
                          <p style={{ color: "#5c6474", fontSize: '0.85rem' }} className="mt-1 line-clamp-3">
                            {c.description_5th_grade || c.description || c.summary}
                          </p>
                        )}
                        <div className="flex items-center gap-3 mt-2">
                          {itemCount && (
                            <span style={{ color: "#5c6474", fontSize: '0.65rem' }}>{itemCount} resources</span>
                          )}
                          {c.theme_id && (THEMES as any)[c.theme_id] && (
                            <span className="flex items-center gap-1" style={{ color: "#5c6474", fontSize: '0.65rem' }}>
