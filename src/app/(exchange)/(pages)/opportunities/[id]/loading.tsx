    ...
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
          <div className="h-6 w-28 bg-white/60 rounded-full animate-pulse" />
          <div className="h-8 w-3/4 bg-white/60 rounded animate-pulse" />
          <div className="flex items-center gap-3 mt-2">
            <div className="h-10 w-10 bg-white/60 rounded-full animate-pulse" />
            <div className="h-4 w-36 bg-white/60 rounded animate-pulse" />
          </div>
