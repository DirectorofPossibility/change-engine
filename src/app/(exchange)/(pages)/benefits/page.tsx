          ...
          <div>
            <div className="space-y-4">
              {(benefits || []).map(function (b) {
                return (
                  <Link key={b.benefit_id} href={`/benefits/${b.benefit_id}`} className="block bg-white rounded-lg border-2 border-brand-border p-5 hover:shadow-md transition-shadow">
