...
export default async function ElectionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  var ballotItems = ballotRes.data || []
  var votingLocations = locationsRes.data || []

  // Group candidates by office_sought
  var candidateGroups: Record<string, typeof candidates> = {}
  candidates.forEach(function (c) {
    var office = c.office_sought || 'Other'
  ...
  var canRegister = election.registration_deadline ? today <= election.registration_deadline : false
