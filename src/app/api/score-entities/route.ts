 ...
 *
 * Scores every entity across 6 types (organizations, elected_officials,
 * content_published, services_211, resources, life_situations) for profile
 * completeness. Pure field-presence scoring — no AI calls.
 *
 * Auth: Requires API key (x-api-key) or cron secret (Bearer token).
 *
 * Body:
 *   { "entity_type": "organization", "force": true }
...
const WEIGHT_MAP = { CRITICAL: 3, IMPORTANT: 2, NICE: 1 }
