        ...
        {Object.entries(CENTERS).map(function ([name, center]) {
          ...
          return (
            <Link
              ...
              className="group flex flex-col items-center text-center gap-4 p-7 bg-white border border-brand-border hover:border-ink hover:-translate-y-0.5 transition-all duration-200"
            >
              {imgSrc && (
                <Image
                  src={imgSrc}
