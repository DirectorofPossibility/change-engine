          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <input
                ...
                className="w-36 pl-7 pr-2 py-1 text-xs border border-brand-border bg-white focus:outline-none focus:border-brand-accent"
              />
            </form>
            <LanguageSwitcher />
            <AuthButton />
            ...
            <div className="pt-3 border-t border-brand-border space-y-3">
              <form onSubmit={handleSearch} className="relative">
                ...
                <input
                  ...
                  placeholder={t('nav.search_placeholder')}
                  aria-label="Search the site"
                  className="w-full pl-7 pr-2 py-2 text-sm border border-brand-border bg-white focus:outline-none focus:border-brand-accent"
                />
              </form>
