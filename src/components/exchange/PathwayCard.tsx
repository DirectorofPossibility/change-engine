  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {description && (
          <p className="line-clamp-2 mb-2" style={{ fontFamily: 'Georgia, "Times New Roman", serif', fontSize: '0.8rem', lineHeight: 1.5, color: '#5c6474' }}>{description}</p>
        )}
        <div className="flex items-center justify-between">
          <span style={{ fontFamily: '"Courier New", Courier, monospace', fontSize: '0.6875rem', letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#1b5e8a' }}>{count} resources</span>
          <span
