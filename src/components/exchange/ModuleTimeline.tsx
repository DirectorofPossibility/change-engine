        ...
        return (
          <div key={mod.moduleId} className="relative pl-10 pb-8 last:pb-0">
            ...
            <div className="bg-white rounded-xl border-2 border-brand-border p-5">
              ...
              <h4 className="font-semibold text-brand-text text-lg font-serif mb-1">{mod.name}</h4>
                ...
                <div className="relative flex flex-wrap gap-2 mb-3">
                  ...
                  {mod.articleUrl && (
                    <a href={mod.articleUrl} target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100 transition-colors">
                      <ExternalLink size={12} /> {mod.articleTitle || 'Read More'}
                    </a>
                  )}
                  {mod.musicUrl && (
                    <a href={mod.musicUrl} target="_blank" rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-purple-50 text-purple-700 border border-purple-200 hover:bg-purple-100 transition-colors">
                      <Music size={12} />
                      {mod.musicTitle
