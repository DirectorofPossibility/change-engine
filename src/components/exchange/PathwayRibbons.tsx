        ...
        {Object.entries(THEMES).map(function ([id, theme]) {
          ...
          return (
            <Link
              ...
              className="group flex-shrink-0 w-[240px] sm:w-auto snap-start bg-white border border-brand-border overflow-hidden hover:border-ink hover:-translate-y-0.5 transition-all duration-200"
            >
              {/* Color accent bar */}
