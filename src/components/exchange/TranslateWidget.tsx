  ...
  return (
    <div ref={ref} className="relative inline-flex">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-brand-muted hover:text-brand-text bg-white/80 hover:bg-white border-2 border-brand-border rounded-lg shadow-sm transition-colors"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 bg-white border-2 border-brand-border rounded-lg shadow-lg overflow-hidden z-50 min-w-[140px]">
