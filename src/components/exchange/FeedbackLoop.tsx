        ...
        {!kind ? (
          ...
          <>
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-brand-accent text-white text-sm font-semibold rounded-lg disabled:opacity-40 hover:bg-brand-accent-hover transition-colors"
            >
