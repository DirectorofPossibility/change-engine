        ...
        {Object.entries(CENTERS).map(function ([name, center]) {
          ...
          return (
            <Link
              ...
              className="group relative flex flex-col items-center text-center gap-5 p-8 min-h-[280px] rounded-3xl bg-white border-2 border-brand-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
            >
