...
const en: Record<string, string> = {
  ...
  'home.subtitle': 'Find resources, know your representatives, and participate in shaping your community.',
...
const es: Record<string, string> = {
  ...
  // Homepage
  'home.location': 'Houston, Texas',
  'home.subtitle': 'Encuentre recursos, conozca a sus representantes y participe en la formación de su comunidad.',
...
const vi: Record<string, string> = {
  ...
  // Homepage
  'home.location': 'Houston, Texas',
  'home.subtitle': 'Tìm tài nguyên, biết đại diện của bạn và tham gia xây dựng cộng đồng.',
