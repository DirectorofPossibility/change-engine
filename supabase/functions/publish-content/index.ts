    ...
    for (const item of queue) {
      ...
      if (isV2) {
        ...
        publishData = {
          ...
          org_id: (inboxItem.org_id as string) || null,
          author: c.author || null,
          subtitle: c.subtitle || null,
          publication_date: c.publication_date || null,
          download_url: c.download_url || null,
          cost: c.cost || null,
          hero_quote: c.hero_quote || null,
          hero_quote_attribution: c.hero_quote_attribution || null,
          parent_inbox_id: (inboxItem.parent_inbox_id as string) || null,
